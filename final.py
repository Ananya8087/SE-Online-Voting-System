...
class voting_system:
    def __init__(self):
        self.db=connector.connect(host='127.0.0.1',port = 3306,user='root',password='ananya123', database='votingsystem')
    ...
    def sign_up(self):
        ...
        while True:   
            ...
            if Sex=='F' or Sex=='M' or Sex=='Other': 
                break
            else : 
        ...
        print("Sex before query execution:", Sex)
